 ...
 */
export function resolveRound(regions, orders, config) {
    ...
    for (const order of orders) {
        totalBySource.set(order.fromRegionId, (totalBySource.get(order.fromRegionId) ?? 0) + order.troops);
    }
...
function resolveAttack(defender, attacks, config) {
