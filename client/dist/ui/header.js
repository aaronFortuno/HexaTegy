...
export class AppHeader {
    ...
    versionHistory;
    theme;
    constructor(container, versionModal) {
        this.container = container;
        this.versionHistory = new VersionHistory(versionModal);
        this.theme = localStorage.getItem("hexategy_theme") ?? "dark";
