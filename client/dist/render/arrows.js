...
export class ArrowRenderer {
    ...
    drawPlanningArrow(ctx, from, to, arrow) {
    ...
    drawAnimatedArrow(ctx, from, to, arrow) {
    ...
    drawDeleteDragArrow(from, to, hasValidTarget) {
        const ctx = this.ctx;
